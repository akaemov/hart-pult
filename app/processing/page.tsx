    ...
    <>
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 py-8">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div className="flex flex-col gap-1">
            ...
            <p className="max-w-[62ch] text-sm text-ink-2">
              ...
              Время везде рабочее: вечер, ночь и выходные не в счёт, иначе заявка в пятницу
              вечером с ответом в понедельник утром выглядит как трое суток молчания.
            </p>
          </div>
        ...
        >
          <div className="flex flex-wrap items-baseline gap-3">
            ...
            <span className="text-ink-2">
              ...
              часов — прямо сейчас, независимо от выбранного периода. Пришедшие в выходные
              начинают ждать с утра понедельника
            </span>
          </div>
        ...
        >
          ...
          {days <= 30 && (
            // На длинном периоде хвост уже дозвонили, на коротком — нет.
            // Без этой оговорки неделя всегда выглядит лучше квартала просто
            // потому, что вчерашним сделкам ещё не успели позвонить.
            <p className="border-l-2 border-line-2 pl-3 text-sm text-ink-3">
              Короткий период льстит: по сделкам, созданным вчера и сегодня, звонок ещё может
              состояться. Доля дошедших до звонка здесь занижена, а медиана — оптимистична.
              Для оценки работы отдела берите 90 дней.
            </p>
          )}
